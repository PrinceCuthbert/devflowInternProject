          ...
          <div className="flex-1 w-full">
            ...
            <div className="flex justify-between items-center mb-8">
              <h1 className="text-3xl font-extrabold text-gray-800 tracking-tight flex items-center gap-3">
                PROJECT REPO{" "}
                <span className="px-3 py-1 bg-[#E8ECFF] text-[#293681] text-sm rounded-full">
                  {tasks.length}
                </span>
              </h1>
              ...
              <div className="flex items-center gap-4">
                <span className="text-sm font-medium text-gray-500">
                  Welcome,{" "}
                  <span className="text-[#293681] font-bold">
                    {user.username}
                  </span>
                </span>
                ...
                {user.role === "admin" && (
                  <>
                    ...
                    <button
                      ...
                      className="text-xs bg-[#E8ECFF] text-[#293681] px-3 py-1.5 rounded-md font-bold hover:bg-[#D9E0FF] transition-colors tracking-wide">
                      SEE ALL USERS
                    </button>
                  </>
                )}
